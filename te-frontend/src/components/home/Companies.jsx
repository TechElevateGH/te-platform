...
// Brand-inspired gradient pairs for fallback initials
...
const CompanyLogo = ({ company, index }) => {
  ...
  return (
    <div className="w-12 h-12 mb-2 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
      ...
      {imgStatus !== "loaded" && (
        <div
          className={`${imgStatus === "loading" ? "absolute" : ""} w-full h-full bg-gradient-to-br ${gradient} rounded-xl flex items-center justify-center text-white text-xl font-bold shadow-inner`}
        >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
            TechElevate members have secured positions at leading tech companies
            worldwide, from big tech to innovative startups and Fortune 500
            enterprises.
          </p>
        </div>
