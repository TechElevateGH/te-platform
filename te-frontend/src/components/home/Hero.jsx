        ...
        <div className="grid items-center gap-14 lg:grid-cols-2">
          ...
          <div>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-x-6 gap-y-2 font-mono text-xs text-[var(--te-text-dim)]">
              ...
              <span className="hidden sm:inline text-[var(--te-border-strong)]">
                |
              </span>
          ...
          <div className="relative">
            <div className="te-card overflow-hidden shadow-sm">
              <div className="flex items-center gap-2 border-b border-[var(--te-border)] bg-[var(--te-surface-alt)] px-4 py-3">
                <span className="h-3 w-3 rounded-full bg-[var(--te-red)]" />
                <span className="h-3 w-3 rounded-full bg-[var(--te-gold)]" />
                <span className="h-3 w-3 rounded-full bg-[var(--te-green)]" />
                <span className="ml-3 font-mono text-xs text-[var(--te-text-dim)]">
                  ~/techelevate — zsh
                </span>
              </div>
              <div className="p-5 font-mono text-[13px] leading-7 text-[var(--te-text)]">
                {terminalLines.map((line, i) => (
                  <div key={i} className="flex gap-2">
                    {line.type === "prompt" && (
                      <>
                        <span className="select-none text-[var(--te-text-dim)]">
                          $
                        </span>
                        <span>{line.text}</span>
                      </>
                    ...
                    {line.type === "out" && (
                      <>
                        ...
                        <span className="text-[var(--te-text-dim)]">
                          {line.text}
                        </span>
                      </>
                    )}
                    {line.type === "next" && (
                      <span className="mt-1 text-[var(--te-text)]">
                        {line.text}
                      </span>
                    )}
                  </div>
