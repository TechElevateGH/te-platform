...
const Members = () => {
  ...
  return (
    <div id="team" className="relative bg-gradient-to-br from-gray-50 via-blue-50/30 to-white py-24 sm:py-32 overflow-hidden">
      {/* Background decoration */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 left-0 -translate-x-1/2 w-96 h-96 bg-blue-200 rounded-full blur-3xl opacity-20"></div>
        <div className="absolute bottom-1/4 right-0 translate-x-1/2 w-96 h-96 bg-cyan-200 rounded-full blur-3xl opacity-20"></div>
      </div>

      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        {/* Section header */}
        <div className="mx-auto max-w-2xl text-center mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/80 backdrop-blur-sm border border-blue-100 shadow-sm mb-4">
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
          {displayedMembers.map((member, index) => (
            ...
            >
              <div className="relative h-full bg-white rounded-3xl shadow-md hover:shadow-2xl transition-all duration-500 overflow-hidden border border-gray-100 hover:border-blue-200 hover:-translate-y-2">
                {/* Image container */}
                  ...
                  <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex gap-3 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-4 group-hover:translate-y-0">
                    {member.linkedin && (
                      <a
                        ...
                        className="p-2.5 bg-white/90 backdrop-blur-sm rounded-full shadow-lg hover:bg-blue-600 hover:text-white transition-all duration-300 hover:scale-110"
                      >
                    ...
                    {member.github && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="p-2.5 bg-white/90 backdrop-blur-sm rounded-full shadow-lg hover:bg-gray-900 hover:text-white transition-all duration-300 hover:scale-110"
                      >
        ...
        {leadership.length > 4 && (
          <div className="mt-12 text-center">
            <button
              ...
              className="group inline-flex items-center gap-2 px-8 py-4 bg-white text-gray-700 font-semibold rounded-full shadow-lg hover:shadow-xl border border-gray-200 hover:border-blue-300 transform hover:scale-105 transition-all duration-300"
            >
