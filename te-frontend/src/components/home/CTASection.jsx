    ...
    <div className="relative bg-gradient-to-br from-blue-900 via-blue-800 to-cyan-900 py-24 sm:py-32 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          ...
          {/* Main heading */}
          <h2 className="text-4xl font-bold tracking-tight text-white sm:text-6xl mb-6 animate-fade-in-up">
            Ready to{' '}
            <span className="relative inline-block">
              ...
              <svg
                className="absolute left-0 top-full w-full h-3 -mt-1"
                viewBox="0 0 300 12"
                fill="none"
          ...
          {/* Description */}
          <p className="text-xl text-blue-100 mb-12 leading-relaxed animate-fade-in" style={{ animationDelay: '0.2s' }}>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12 animate-fade-in" style={{ animationDelay: '0.4s' }}>
            <button
              ...
              className="group relative px-10 py-5 bg-white text-blue-900 font-bold text-lg rounded-full shadow-2xl hover:shadow-[0_0_50px_rgba(255,255,255,0.5)] transform hover:scale-105 transition-all duration-300 overflow-hidden"
            >
            ...
            <button
              ...
              className="group px-10 py-5 bg-white/10 backdrop-blur-sm text-white font-bold text-lg rounded-full shadow-xl hover:bg-white/20 border border-white/30 hover:border-white/50 transform hover:scale-105 transition-all duration-300"
            >
          ...
          {/* Trust indicators */}
          <div className="flex flex-wrap justify-center gap-8 text-white/80 text-sm animate-fade-in" style={{ animationDelay: '0.6s' }}>
        ...
        <div className="mt-20 grid grid-cols-2 sm:grid-cols-4 gap-8 max-w-5xl mx-auto opacity-70">
          {[
            ...
            <div key={idx} className="text-center">
              <div className="text-3xl font-bold text-cyan-300 mb-1">{item.value}</div>
