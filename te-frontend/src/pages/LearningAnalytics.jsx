                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className={`flex rounded-lg p-0.5 ${darkMode ? 'bg-gray-700' : 'bg-gray-200'}`}>
                                            <button
                                                ...
                                                className={`px-3 py-1 rounded-md text-xs font-medium transition-all ${viewMode === 'member'
                                            ...
                                            <button
                                                ...
                                                className={`px-3 py-1 rounded-md text-xs font-medium transition-all ${viewMode === 'topic'
                                                        ? 'bg-indigo-600 text-white shadow-sm'
                                                        : darkMode ? 'text-gray-300 hover:text-white' : 'text-gray-600 hover:text-gray-900'
                                                    }`}
                                            >
                                        ...
                                        <div>
                                            ...
                                            <div className="space-y-1 max-h-64 overflow-y-auto">
                                                {selectedMember.completed_topics.map((topic, idx) => (
                                                    <div
                                                        key={idx}
                                                        className={`flex items-center justify-between p-2.5 rounded-lg ${darkMode ? 'bg-gray-700/30' : 'bg-gray-50'
                                                            }`}
                                                    >
                                                        <span className="text-sm font-medium text-gray-900 dark:text-white">{topic.topic_name}</span>
                                        ...
                                        <div>
                                            ...
                                            <div className="space-y-1 max-h-64 overflow-y-auto">
                                                {selectedTopic.completed.map((member, idx) => (
                                                    <div
                                                        key={idx}
                                                        className={`p-2.5 rounded-lg ${darkMode ? 'bg-gray-700/30' : 'bg-gray-50'}`}
                                                    >
